...
echo "Overwriting README.md with a parser-safe Mermaid diagram"
cat > README.md << 'README_OVERWRITE_DELIM'
# Vantage
...
git add -A
git commit -m "docs: overwrite README with simplified safe Mermaid syntax"
