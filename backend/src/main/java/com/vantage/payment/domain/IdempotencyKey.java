...
@Entity
@FilterDef(name = "tenantFilter_IdempotencyKey", parameters = @ParamDef(name = "tenantId", type = UUID.class))
@Filter(name = "tenantFilter_IdempotencyKey", condition = "tenant_id = :tenantId")
